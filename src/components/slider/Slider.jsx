                    ...
                    sliderData.map((slide, index) => (
                        <SwiperSlide key={index} className="swiper-slide relative">
                            <div className='relative'>
                                <img className='w-full h-[70vb] lg:h-[110vb] ' loading='eager' alt='img' src={slide.img} />
                                <div className='absolute top-0 bottom-0 right-0 left-0 bg-black bg-opacity-50'></div>

                            </div>
                            <div className='absolute inset-0 top-52 flex flex-col justify-center text-center items-center '>
                                ...
                                <Link href={'/'} className=' my-14 bg-primary_Color_Light hover:bg-primary_Color_dark text-base lg:text-lg text-white ] py-3 px-4   '>Discover More</Link>
                                <div className='w-[80%]'>
